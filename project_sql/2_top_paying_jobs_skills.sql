...
helping understand which skills to develop to align with top salaries
*/
...
/*
The top skills frequently required for data analyst roles based on the job postings are:
